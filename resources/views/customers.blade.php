                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="table-responsive">
                            <table class="table m-0">
                                ...
                                <tbody>
                                @foreach ($Sympathieclients as $Sympathieclient)

                                    <tr>
                                        <th scope="row">{{ $Sympathieclient->id}}</th>
                                        <td data-title="N om comple">{{ $Sympathieclient->NomClint}} {{ $Sympathieclient->PrenomClient}}</td>
                                        <td data-title="Email">{{ $Sympathieclient->EmailClient}}</td>

                                        <td data-title="Sympathie">{{ $Sympathieclient->NOTECLIENt}}</td>
                                        ...
                                        <td>
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    ...
                                                    <a class="btn btn-danger btn-sm rounded-0"  href="{{'customerbloquer/'.$Sympathieclient->id }}">@if($Sympathieclient->etat != 'bloque') Bloquer @else Debloquer @endif</a>
                                                </li>
                                            </ul>
                                        </td>
