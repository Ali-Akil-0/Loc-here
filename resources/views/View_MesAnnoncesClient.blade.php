...
<body class="app__body">
    ...
    <main class="app__inscriptionMain app__acceuilMain">
        ...
        <div class="app__annoncesContenuTitre">
            <p class="app__annoncesTitre sizetext">Mes annonces</p>
            <p class="app__annoncesTitre">page 1 de 10</p>
        </div>
        <div>
            <p>Vous trouverez ci-dessous une liste de toutes vos annonces classées. 
Cliquez sur l'une des options pour effectuer une tâche spécifique. Si vous avez des questions, 
veuillez contacter l'administrateur du site.</p>
        </div>
